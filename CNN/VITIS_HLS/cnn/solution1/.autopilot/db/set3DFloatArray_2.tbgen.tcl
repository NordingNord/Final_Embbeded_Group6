...
set C_modelArgList {
	{ array_r float 32 regular {array 5408 { 0 3 } 0 1 }  }
}
...
set portList { 
	...
	{ array_r_address0 sc_out sc_lv 13 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "array_r_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":13, "type": "signal", "bundle":{"name": "array_r", "role": "address0" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_4ns_10ns_6ns_13_4_1_U44", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "5412", "Max" : "5412"}
	, {"Name" : "Interval", "Min" : "5412", "Max" : "5412"}
]}
...
set Spec2ImplPortList { 
	array_r { ap_memory {  { array_r_address0 mem_address 1 13 }  { array_r_ce0 mem_ce 1 1 }  { array_r_we0 mem_we 1 1 }  { array_r_d0 mem_din 1 32 } } }
}
