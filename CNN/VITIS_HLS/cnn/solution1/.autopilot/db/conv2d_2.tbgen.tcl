...
set C_modelArgList {
	...
	{ output_r float 32 regular {array 15488 { 2 3 } 1 1 }  }
}
...
set portList { 
	...
	{ grp_fu_1057_p_opcode sc_out sc_lv 2 signal -1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "grp_fu_1057_p_opcode", "direction": "out", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "grp_fu_1057_p_opcode", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_5ns_6ns_9_1_1_U7", "Parent" : "0"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "820865", "Max" : "820865"}
	, {"Name" : "Interval", "Min" : "820865", "Max" : "820865"}
]}
...
set Spec2ImplPortList { 
	...
	output_r { ap_memory {  { output_r_address0 mem_address 1 14 }  { output_r_ce0 mem_ce 1 1 }  { output_r_we0 mem_we 1 1 }  { output_r_d0 mem_din 1 32 }  { output_r_q0 mem_dout 0 32 } } }
}
