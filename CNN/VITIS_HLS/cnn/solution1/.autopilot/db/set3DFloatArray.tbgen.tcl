...
set C_modelArgList {
	{ array_r float 32 regular {array 800 { 0 3 } 0 1 }  }
}
...
set Spec2ImplPortList { 
	array_r { ap_memory {  { array_r_address0 mem_address 1 10 }  { array_r_ce0 mem_ce 1 1 }  { array_r_we0 mem_we 1 1 }  { array_r_d0 mem_din 1 32 } } }
}
