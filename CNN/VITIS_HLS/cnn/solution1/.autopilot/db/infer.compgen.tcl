...
set id 71
set name infer_urem_15ns_12ns_15_19_1
...
set id 75
set name infer_mul_mul_5ns_11ns_15_4_1
...
set ID 85
set hasByteEnable 0
set MemName infer_layer_2_output_9
set CoreName ap_simcore_mem
set PortList { 2 1 }
set DataWd 32
set AddrRange 1547
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_infer_input_V \
    op interface \
    ports { infer_input_V_dout { I 32 vector } infer_input_V_empty_n { I 1 bit } infer_input_V_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_infer_output_V \
    op interface \
    ports { infer_output_V_din { O 32 vector } infer_output_V_full_n { I 1 bit } infer_output_V_write { O 1 bit } } \
} "
}
