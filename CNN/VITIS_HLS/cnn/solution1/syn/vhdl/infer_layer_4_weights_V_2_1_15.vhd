...
entity infer_layer_4_weights_V_2_1_15_rom is 
    generic(
             DWIDTH     : integer := 16; 
             AWIDTH     : integer := 5; 
             MEM_SIZE    : integer := 32
...
architecture rtl of infer_layer_4_weights_V_2_1_15_rom is 
...
entity infer_layer_4_weights_V_2_1_15 is
    generic (
...
architecture arch of infer_layer_4_weights_V_2_1_15 is
    component infer_layer_4_weights_V_2_1_15_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    infer_layer_4_weights_V_2_1_15_rom_U :  component infer_layer_4_weights_V_2_1_15_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
