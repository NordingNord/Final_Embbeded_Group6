...
entity infer_conv2d_layer_4_bias_rom is 
    generic(
             DWIDTH     : integer := 32; 
             AWIDTH     : integer := 5; 
             MEM_SIZE    : integer := 32
...
architecture rtl of infer_conv2d_layer_4_bias_rom is 
...
entity infer_conv2d_layer_4_bias is
    generic (
...
architecture arch of infer_conv2d_layer_4_bias is
    component infer_conv2d_layer_4_bias_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    infer_conv2d_layer_4_bias_rom_U :  component infer_conv2d_layer_4_bias_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
