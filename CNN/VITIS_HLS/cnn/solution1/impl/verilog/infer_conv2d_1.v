...
wire   [9:0] empty_94_fu_468_p3;
reg   [9:0] empty_94_reg_882;
...
infer_mac_muladd_5ns_6ns_5ns_10_4_1 #(
    ...
    .din2_WIDTH( 5 ),
    .dout_WIDTH( 10 ))
mac_muladd_5ns_6ns_5ns_10_4_1_U30(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_842_p0),
    .din1(grp_fu_842_p1),
...
always @ (posedge ap_clk) begin
    if (((icmp_ln66_fu_336_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        empty_94_reg_882 <= empty_94_fu_468_p3;
...
assign add52_mid2_fu_484_p3 = {{empty_94_reg_882}, {5'd0}};
...
assign empty_89_fu_507_p1 = indvars_iv_next37_fu_497_p2[1:0];

assign empty_91_fu_625_p1 = indvars_iv_next37_mid1_fu_615_p2[1:0];

assign empty_93_fu_418_p2 = (icmp_ln69_fu_342_p2 | and_ln66_fu_398_p2);

assign empty_94_fu_468_p3 = ((and_ln66_fu_398_p2[0:0] == 1'b1) ? mul4811_mid1_fu_454_p2 : select_ln66_6_fu_460_p3);
...
assign grp_fu_996_p_din1 = layer_4_weights_load_reg_962;
...
assign iii_mid2_fu_424_p3 = ((empty_93_fu_418_p2[0:0] == 1'b1) ? 6'd0 : iii_reg_207);
...
assign p_shl_fu_511_p3 = {{empty_89_fu_507_p1}, {2'd0}};

assign p_shl_mid1_fu_629_p3 = {{empty_91_fu_625_p1}, {2'd0}};
