...
entity infer_layer_4_weights_V_2_1_4_rom is 
    generic(
             DWIDTH     : integer := 14; 
             AWIDTH     : integer := 5; 
             MEM_SIZE    : integer := 32
...
architecture rtl of infer_layer_4_weights_V_2_1_4_rom is 
...
entity infer_layer_4_weights_V_2_1_4 is
    generic (
...
architecture arch of infer_layer_4_weights_V_2_1_4 is
    component infer_layer_4_weights_V_2_1_4_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    infer_layer_4_weights_V_2_1_4_rom_U :  component infer_layer_4_weights_V_2_1_4_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
