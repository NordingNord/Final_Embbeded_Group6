...
architecture rtl of infer_layer_3_output_V_ram is 
...
architecture arch of infer_layer_3_output_V is
    component infer_layer_3_output_V_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    infer_layer_3_output_V_ram_U :  component infer_layer_3_output_V_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
