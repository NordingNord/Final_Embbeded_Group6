...
entity infer_layer_4_weights_V_0_0_1_rom is 
    generic(
             DWIDTH     : integer := 16; 
             AWIDTH     : integer := 5; 
             MEM_SIZE    : integer := 32
...
architecture rtl of infer_layer_4_weights_V_0_0_1_rom is 
...
signal mem : mem_array := (
    ...
    30 => "0000000111101110", 31 => "1111010101100010" );
...
entity infer_layer_4_weights_V_0_0_1 is
    generic (
...
architecture arch of infer_layer_4_weights_V_0_0_1 is
    component infer_layer_4_weights_V_0_0_1_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    infer_layer_4_weights_V_0_0_1_rom_U :  component infer_layer_4_weights_V_0_0_1_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
