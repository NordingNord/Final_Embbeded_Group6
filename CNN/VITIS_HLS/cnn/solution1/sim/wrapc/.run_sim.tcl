...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "infer.autotvin.dat"
	set constFileTvOut       "infer.autotvout.dat"
	set constFileHdlTvIn     "infer.autohdltvin.dat"
	set constFileHdlTvOut    "infer.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
