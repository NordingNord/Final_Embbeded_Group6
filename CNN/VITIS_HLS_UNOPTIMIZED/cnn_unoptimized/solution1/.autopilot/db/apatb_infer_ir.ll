; ModuleID = '/home/frank/Documents/Git/Final_Embbeded_Group6/CNN/VITIS_HLS_UNOPTIMIZED/cnn_unoptimized/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

%"class.hls::stream" = type { %"struct.hls::axis" }
%"struct.hls::axis" = type { %struct.ap_uint, %struct.ap_uint.1, %struct.ap_uint.1, %struct.ap_uint.4, %struct.ap_uint.7, %struct.ap_uint.10, %struct.ap_uint.13 }
%struct.ap_uint = type { %struct.ap_fixed_base.31 }
%struct.ap_fixed_base.31 = type { %struct.ssdm_int.32 }
%struct.ssdm_int.32 = type { i32 }
...
%struct.ssdm_int.12 = type { i5 }
%struct.ap_uint.13 = type { %struct.ap_int_base.14 }
%struct.ap_int_base.14 = type { %struct.ssdm_int.15 }
%struct.ssdm_int.15 = type { i6 }

; Function Attrs: noinline
define void @apatb_infer_ir(%"class.hls::stream"* %infer_input, %"class.hls::stream"* %infer_output) local_unnamed_addr #0 {
entry:
  %infer_input_copy = alloca %"class.hls::stream", align 512
  %infer_output_copy = alloca %"class.hls::stream", align 512
  call fastcc void @copy_in(%"class.hls::stream"* %infer_input, %"class.hls::stream"* nonnull align 512 %infer_input_copy, %"class.hls::stream"* %infer_output, %"class.hls::stream"* nonnull align 512 %infer_output_copy)
  call void @apatb_infer_hw(%"class.hls::stream"* %infer_input_copy, %"class.hls::stream"* %infer_output_copy)
  call fastcc void @copy_out(%"class.hls::stream"* %infer_input, %"class.hls::stream"* nonnull align 512 %infer_input_copy, %"class.hls::stream"* %infer_output, %"class.hls::stream"* nonnull align 512 %infer_output_copy)
  ret void
}
...
; <label>:13:                                     ; preds = %11
  call fastcc void @streamcpy_hls.p0struct.ap_fixed_base.31(%struct.ap_fixed_base.31* align 512 %.01.0.05, %struct.ap_fixed_base.31* %.0.0.04)
  br label %19
...
; <label>:19:                                     ; preds = %17, %16, %13, %10
  ...
  %20 = bitcast %struct.ap_uint.1* %.0.110 to i8*
  %21 = call i1 @fpga_fifo_exist_1(i8* %20)
  br i1 %21, label %22, label %23

; <label>:22:                                     ; preds = %19
  call fastcc void @streamcpy_hls.p0struct.ap_uint.1(%struct.ap_uint.1* %.01.111, %struct.ap_uint.1* %.0.110)
  br label %34
...
; <label>:23:                                     ; preds = %19
  ...
  %24 = bitcast %struct.ap_int_base.2* %.0.1.012 to i8*
  %25 = call i1 @fpga_fifo_exist_1(i8* %24)
  br i1 %25, label %26, label %27

; <label>:26:                                     ; preds = %23
  call fastcc void @streamcpy_hls.p0struct.ap_int_base.2(%struct.ap_int_base.2* %.01.1.013, %struct.ap_int_base.2* %.0.1.012)
  br label %34
...
; <label>:27:                                     ; preds = %23
  ...
  %28 = bitcast %struct.ssdm_int.3* %.0.1.0.014 to i8*
  %29 = call i1 @fpga_fifo_exist_1(i8* %28)
  br i1 %29, label %30, label %31

; <label>:30:                                     ; preds = %27
  call fastcc void @streamcpy_hls.p0struct.ssdm_int.3(%struct.ssdm_int.3* %.01.1.0.015, %struct.ssdm_int.3* %.0.1.0.014)
  br label %34
...
; <label>:34:                                     ; preds = %31, %30, %26, %22
  ...
  %35 = bitcast %struct.ap_uint.1* %.0.218 to i8*
  %36 = call i1 @fpga_fifo_exist_1(i8* %35)
  br i1 %36, label %37, label %38

; <label>:37:                                     ; preds = %34
  call fastcc void @streamcpy_hls.p0struct.ap_uint.1(%struct.ap_uint.1* %.01.219, %struct.ap_uint.1* %.0.218)
  br label %49
...
; <label>:38:                                     ; preds = %34
  ...
  %39 = bitcast %struct.ap_int_base.2* %.0.2.020 to i8*
  %40 = call i1 @fpga_fifo_exist_1(i8* %39)
  br i1 %40, label %41, label %42

; <label>:41:                                     ; preds = %38
  call fastcc void @streamcpy_hls.p0struct.ap_int_base.2(%struct.ap_int_base.2* %.01.2.021, %struct.ap_int_base.2* %.0.2.020)
  br label %49
...
; <label>:42:                                     ; preds = %38
  ...
  %43 = bitcast %struct.ssdm_int.3* %.0.2.0.022 to i8*
  %44 = call i1 @fpga_fifo_exist_1(i8* %43)
  br i1 %44, label %45, label %46

; <label>:45:                                     ; preds = %42
  call fastcc void @streamcpy_hls.p0struct.ssdm_int.3(%struct.ssdm_int.3* %.01.2.0.023, %struct.ssdm_int.3* %.0.2.0.022)
  br label %49
...
; <label>:49:                                     ; preds = %46, %45, %41, %37
  ...
  %50 = bitcast %struct.ap_uint.4* %.0.326 to i8*
  %51 = call i1 @fpga_fifo_exist_1(i8* %50)
  br i1 %51, label %52, label %53

; <label>:52:                                     ; preds = %49
  call fastcc void @streamcpy_hls.p0struct.ap_uint.4(%struct.ap_uint.4* %.01.327, %struct.ap_uint.4* %.0.326)
  br label %64
...
; <label>:53:                                     ; preds = %49
  ...
  %54 = bitcast %struct.ap_int_base.5* %.0.3.028 to i8*
  %55 = call i1 @fpga_fifo_exist_1(i8* %54)
  br i1 %55, label %56, label %57

; <label>:56:                                     ; preds = %53
  call fastcc void @streamcpy_hls.p0struct.ap_int_base.5(%struct.ap_int_base.5* %.01.3.029, %struct.ap_int_base.5* %.0.3.028)
  br label %64
...
; <label>:57:                                     ; preds = %53
  ...
  %58 = bitcast %struct.ssdm_int.6* %.0.3.0.030 to i8*
  %59 = call i1 @fpga_fifo_exist_1(i8* %58)
  br i1 %59, label %60, label %61

; <label>:60:                                     ; preds = %57
  call fastcc void @streamcpy_hls.p0struct.ssdm_int.6(%struct.ssdm_int.6* %.01.3.0.031, %struct.ssdm_int.6* %.0.3.0.030)
  br label %64
...
; Function Attrs: argmemonly noinline
define internal fastcc void @streamcpy_hls.p0struct.ap_fixed_base.31(%struct.ap_fixed_base.31* noalias nocapture align 512, %struct.ap_fixed_base.31* noalias nocapture) unnamed_addr #3 {
entry:
  %2 = alloca %struct.ap_fixed_base.31
  br label %empty

empty:                                            ; preds = %push, %entry
  %3 = bitcast %struct.ap_fixed_base.31* %1 to i8*
  %4 = call i1 @fpga_fifo_not_empty_4(i8* %3)
  br i1 %4, label %push, label %ret

push:                                             ; preds = %empty
  %5 = bitcast %struct.ap_fixed_base.31* %2 to i8*
  %6 = bitcast %struct.ap_fixed_base.31* %1 to i8*
  call void @fpga_fifo_pop_4(i8* %5, i8* %6)
  %7 = load volatile %struct.ap_fixed_base.31, %struct.ap_fixed_base.31* %2
  %8 = bitcast %struct.ap_fixed_base.31* %2 to i8*
  %9 = bitcast %struct.ap_fixed_base.31* %0 to i8*
  call void @fpga_fifo_push_4(i8* %8, i8* %9)
  br label %empty, !llvm.loop !8

ret:                                              ; preds = %empty
  %10 = bitcast %struct.ap_fixed_base.31* %1 to i8*
  %11 = bitcast %struct.ap_fixed_base.31* %0 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %11, i8* align 1 %10, i64 4, i1 false)
  ret void
}
...
; Function Attrs: argmemonly noinline
define internal fastcc void @streamcpy_hls.p0struct.ssdm_int.9(%struct.ssdm_int.9* noalias nocapture, %struct.ssdm_int.9* noalias nocapture) unnamed_addr #3 {
entry:
...
declare void @apatb_infer_hw(%"class.hls::stream"*, %"class.hls::stream"*)

define void @infer_hw_stub_wrapper(%"class.hls::stream"*, %"class.hls::stream"*) #6 {
entry:
  call void @copy_out(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream"* null, %"class.hls::stream"* %1)
  call void @infer_hw_stub(%"class.hls::stream"* %0, %"class.hls::stream"* %1)
  call void @copy_in(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream"* null, %"class.hls::stream"* %1)
  ret void
}

declare void @infer_hw_stub(%"class.hls::stream"*, %"class.hls::stream"*)
