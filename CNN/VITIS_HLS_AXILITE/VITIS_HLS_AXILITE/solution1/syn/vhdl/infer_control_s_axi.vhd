...
end entity infer_control_s_axi;
...
architecture behave of infer_control_s_axi is
    ...
    constant ADDR_IN_R_BASE   : INTEGER := 16#4000#;
    constant ADDR_IN_R_HIGH   : INTEGER := 16#7fff#;
    ...
    -- memory signals
    signal int_in_r_address0   : UNSIGNED(11 downto 0);
    ...
    signal int_in_r_address1   : UNSIGNED(11 downto 0);
    ...
    component infer_control_s_axi_ram is
        generic (
            BYTES   : INTEGER :=4;
            DEPTH   : INTEGER :=256;
            AWIDTH  : INTEGER :=8);
    ...
    end component infer_control_s_axi_ram;
...
-- ----------------------- Instantiation------------------
-- int_in_r
int_in_r : infer_control_s_axi_ram
generic map (
     BYTES    => 4,
     DEPTH    => 3600,
     AWIDTH   => log2(3600))
...
-- ----------------------- Memory logic ------------------
    ...
    int_in_r_address1    <= raddr(13 downto 2) when ar_hs = '1' else waddr(13 downto 2);
...
entity infer_control_s_axi_ram is
    generic (
        BYTES   : INTEGER :=4;
        DEPTH   : INTEGER :=256;
        AWIDTH  : INTEGER :=8);
...
end entity infer_control_s_axi_ram;

architecture behave of infer_control_s_axi_ram is
