...
// wrapc file define:
#define AUTOTB_TVIN_in "../tv/cdatafile/c.infer.autotvin_in_r.dat"
#define AUTOTB_TVOUT_in "../tv/cdatafile/c.infer.autotvout_in_r.dat"
// wrapc file define:
#define AUTOTB_TVOUT_return "../tv/cdatafile/c.infer.autotvout_ap_return.dat"

#define INTER_TCL "../tv/cdatafile/ref.tcl"

// tvout file define:
#define AUTOTB_TVOUT_PC_in "../tv/rtldatafile/rtl.infer.autotvout_in_r.dat"
#define AUTOTB_TVOUT_PC_return "../tv/rtldatafile/rtl.infer.autotvout_ap_return.dat"
...
extern "C" int infer_hw_stub_wrapper(volatile void *);
...
sc_bv<32> __xlx_tmp_lv = ((int*)__xlx_apatb_param_in)[j];
  ...
  tcl_file.set_num(3600, &tcl_file.in_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_in, __xlx_sprintf_buffer.data());
}
CodeState = CALL_C_DUT;
int ap_return = infer_hw_stub_wrapper(__xlx_apatb_param_in);
