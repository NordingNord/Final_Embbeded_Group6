...
localparam
    ...
    ADDR_IER         = 15'h0008,
    ADDR_ISR         = 15'h000c,
    ADDR_AP_RETURN_0 = 15'h0010,
    ADDR_IN_R_BASE   = 15'h4000,
    ADDR_IN_R_HIGH   = 15'h7fff,
    WRIDLE           = 2'd0,
    WRDATA           = 2'd1,
    WRRESP           = 2'd2,
    WRRESET          = 2'd3,
...
assign int_in_r_address1 = ar_hs? raddr[13:2] : waddr[13:2];
...
module infer_control_s_axi_ram
#(parameter
    BYTES  = 4,
    DEPTH  = 256,
    AWIDTH = log2(DEPTH)
