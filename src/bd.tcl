...
proc create_root_design { parentCell } {
  ...
  set infer_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:infer:1.0 infer_0 ]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins infer_0/ap_rst_n] [get_bd_pins rst_ps8_0_100M/peripheral_aresetn]
  ...
  assign_bd_address -offset 0xA0000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs infer_0/s_axi_control/Reg] -force
