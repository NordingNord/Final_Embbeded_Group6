...
entity infer_layer_4_weights_V_0_0_10_rom is 
    generic(
             DWIDTH     : integer := 14; 
             AWIDTH     : integer := 5; 
             MEM_SIZE    : integer := 32
...
architecture rtl of infer_layer_4_weights_V_0_0_10_rom is 
...
entity infer_layer_4_weights_V_0_0_10 is
    generic (
...
architecture arch of infer_layer_4_weights_V_0_0_10 is
    component infer_layer_4_weights_V_0_0_10_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    infer_layer_4_weights_V_0_0_10_rom_U :  component infer_layer_4_weights_V_0_0_10_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
