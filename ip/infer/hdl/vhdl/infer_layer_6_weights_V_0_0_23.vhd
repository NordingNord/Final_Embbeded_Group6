...
entity infer_layer_6_weights_V_0_0_23_rom is 
    generic(
             DWIDTH     : integer := 16; 
             AWIDTH     : integer := 5; 
             MEM_SIZE    : integer := 32
...
architecture rtl of infer_layer_6_weights_V_0_0_23_rom is 
...
signal mem : mem_array := (
    ...
    30 => "0000110110001111", 31 => "0001011111101001" );
...
entity infer_layer_6_weights_V_0_0_23 is
    generic (
...
architecture arch of infer_layer_6_weights_V_0_0_23 is
    component infer_layer_6_weights_V_0_0_23_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    infer_layer_6_weights_V_0_0_23_rom_U :  component infer_layer_6_weights_V_0_0_23_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
